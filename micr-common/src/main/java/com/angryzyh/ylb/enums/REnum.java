...
public enum REnum {
    ...
    UNKNOWN_ERROR("99999","系统未知异常,请联系管理员"),

    CLIENT_ERROR("A0001","用户端错误"),

    CLIENT_REGISTER("A0100","用户注册错误"),

    CLIENT_NAME_CHECK_ERROR("A0110","用户名校验失败"),

    CLIENT_NAME_EXIST("A0111","用户名已存在"),

    CLIENT_PWD_CHECK_ERROR("A0120","密码校验失败"),

    CLIENT_PWD_LENGTH("A0121","密码长度不够"),

    CLIENT_CODE_ERROR("A0130","校验码输入错误"),

    CLIENT_LOGIN_ERROR("A0200","用户登陆异常"),

    CLIENT_FREEZE("A0202","用户账户被冻结"),

    CLIENT_PWD_ERROR("A0210","用户密码错误"),

    ACCOUNT_FREEZE("A0322","账号被冻结"),

    SYS_ERROR("B0001","系统执行出错"),
